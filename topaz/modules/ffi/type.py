...
BUFFER_IN = native('BUFFER_IN', ffi=clibffi.ffi_type_pointer, lltype=rffi.VOIDP)
BUFFER_OUT = native('BUFFER_OUT', ffi=clibffi.ffi_type_pointer, lltype=rffi.VOIDP)
BUFFER_INOUT = native('BUFFER_INOUT', ffi=clibffi.ffi_type_pointer, lltype=rffi.VOIDP)
